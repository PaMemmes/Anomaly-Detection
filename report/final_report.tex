...
\end{equation}
	...
	\begin{figure}[!tbp]
	\centering
	\subfloat[Feed forward network]{\includegraphics[width=0.333\textwidth]{best/baseline/confusion_baseline.png}\label{fig:f7}}
	\hfill
	\subfloat[Autoencoder]{\includegraphics[width=0.333\textwidth]{best/autoencoder/confusion_autoencoder.png}\label{fig:f8}}
	\hfill
	\subfloat[GAN]{\includegraphics[width=0.333\textwidth]{best/gan/confusion_gan.png}\label{fig:f9}}
