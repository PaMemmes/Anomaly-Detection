...
\begin{document}
  ...
  for epochs:
	...
	\begin{figure}[!tbp]
		\centering
		\subfloat[Feed forward network]{\includegraphics[width=0.3\textwidth]{figures/baseline/accuracy_baseline.png}\label{fig:f1}}
		\hfill
		\subfloat[Autoencoder]{\includegraphics[width=0.3\textwidth]{figures/baseline/loss_baseline.png}\label{fig:f2}}
		\hfill
		\subfloat[GAN]{\includegraphics[width=0.3\textwidth]{figures/baseline/roc_baseline.png}\label{fig:f3}}
		\caption{Accuracy in training}
	\end{figure}
	
	\begin{figure}[!tbp]
		\centering
		\subfloat[Feed forward network]{\includegraphics[width=0.3\textwidth]{figures/baseline/accuracy_baseline.png}\label{fig:f4}}
		\hfill
		\subfloat[Autoencoder]{\includegraphics[width=0.3\textwidth]{figures/baseline/loss_baseline.png}\label{fig:f5}}
		\hfill
		\subfloat[GAN]{\includegraphics[width=0.3\textwidth]{figures/baseline/roc_baseline.png}\label{fig:f6}}
		\caption{Confusion matrices}
	\end{figure}

	\begin{figure}[!tbp]
		\centering
		\subfloat[Feed forward network]{\includegraphics[width=0.3\textwidth]{figures/baseline/accuracy_baseline.png}\label{fig:f7}}
		\hfill
		\subfloat[Autoencoder]{\includegraphics[width=0.3\textwidth]{figures/baseline/loss_baseline.png}\label{fig:f8}}
		\hfill
		\subfloat[GAN]{\includegraphics[width=0.3\textwidth]{figures/baseline/roc_baseline.png}\label{fig:f9}}
		\caption{ROC curves}
	\end{figure}
